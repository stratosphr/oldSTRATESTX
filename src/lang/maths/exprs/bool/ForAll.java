...
public final class ForAll extends AQuantifier {
    ...
    public ForAll(ABoolExpr expr, VarDef... varDefs) {
        super(new Implies(new And(Arrays.stream(varDefs).map(varDef -> new InDomain(new Var(varDef.getUnPrimedName()), varDef.getDomain())).toArray(ABoolExpr[]::new)), expr), varDefs);
    }
